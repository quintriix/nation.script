        ...
        function tab.new_section(section_name)
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    -- Asumiendo que 'type' es la variable que determina el tipo de elemento
                    if type == "TextBox" then
                        Border.Size = Border.Size + UDim2.new(0, 0, 0, 30)

                        -- Definimos el valor por defecto
                        value = {Text = data.default and data.default or "0"}
                        ...
                        local TextBox = library:create("TextBox", {
                            ...
                            Size = UDim2.new(0, 215, 0, 20),
                            Font = Enum.Font.Ubuntu,
                            Text = value.Text,  -- Usar el valor inicial
                            TextColor3 = Color3.fromRGB(150, 150, 150),
                            TextSize = 14,
                            PlaceholderText = "Ingresa texto",  -- Puedes cambiarlo si quieres
                            ClearTextOnFocus = false,
                        }, ButtonFrame)

                        -- Animaciones y eventos del TextBox
                        ...
                        -- Llamar a set_value con el valor inicial
                        element:set_value(value, true)
                    end
