...
elseif type == "TextBox" then
    ...
    print("Data:", data)  -- Depuración
    local defaultText = data.default and data.default.Text or "0"
    print("Default Text:", defaultText)  -- Depuración
    ...
    function element:set_value(new_value, cb)
        ...
        if value and value.Text then
            ...
            print("Value is nil or doesn't have Text:", value)  -- Depuración
        end
